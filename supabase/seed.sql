-- ============================================================
-- FIFA World Cup 2026 — Supabase Schema & Seed
-- ============================================================
...
CREATE POLICY "Public read matches" ON wc2026_matches
  FOR SELECT USING (true);

CREATE POLICY "Public read config" ON wc2026_config
  FOR SELECT USING (true);
...
-- ============================================================
-- KNOCKOUT STAGE — 32 matches (R32 → R16 → QF → SF → Final)
-- ============================================================
-- Team names TBD; placeholders use group position notation.
