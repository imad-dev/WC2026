    ...
    <div className="w-full bg-[#030408] flex flex-col min-h-screen">
      ...
      <article className="max-w-4xl mx-auto px-4 py-12 text-white w-full" dir="rtl">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-[var(--wc-green)] leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
          بث مباشر وتغطية حية لمباريات 17 و 18 يونيو في كأس العالم 2026: قمة أوروبية نارية وظهور مميز للعنابي القطري
        </h1>
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-lg font-sans">
          <p>
            ...
            تتجه أنظار عشاق كرة القدم حول العالم يومي 17 و 18 يونيو 2026 نحو مواجهات حاسمة ومثيرة، 
            حيث تشهد البطولة قمة أوروبية كلاسيكية ثأرية، إلى جانب استمرار المشاركة العربية بظهور المنتخب القطري الطامح لكتابة التاريخ. 
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4 border-r-4 border-[var(--wc-red)] pr-4">
            موعد مباراة إنجلترا ضد كرواتيا (المجموعة الثانية عشرة - 17 يونيو)
          </h2>
          <p>
            في مواجهة نارية مرتقبة بملعب إيه تي أند تي (AT&T Stadium) في دالاس، يصطدم <strong>المنتخب الإنجليزي</strong> (الأسود الثلاثة) 
            بنظيره <strong>الكرواتي</strong> في قمة أوروبية من العيار الثقيل. تسعى إنجلترا المدججة بنجوم الدوري الإنجليزي الممتاز لتأكيد قوتها والمنافسة على اللقب، 
            بينما يأمل المنتخب الكرواتي بخبرته الكبيرة ومكر لاعبيه في خطف النقاط الثلاث. هل تبتسم الكرة للإنجليز أم تواصل كرواتيا تألقها في المواعيد الكبرى؟
          </p>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4 border-r-4 border-[var(--wc-red)] pr-4">
            موعد مباراة البرتغال ضد الكونغو الديمقراطية (المجموعة الحادية عشرة - 17 يونيو)
          </h2>
          <p>
            تتجه الأنظار نحو ملعب إن آر جي (NRG Stadium) في هيوستن لمتابعة <strong>المنتخب البرتغالي</strong> بترسانته الهجومية 
            في مواجهة محفوفة بالمخاطر أمام <strong>الكونغو الديمقراطية</strong>. تسعى البرتغال لتحقيق فوز مريح وتوجيه إنذار لباقي المنافسين منذ البداية، 
            لكن المنتخب الأفريقي الطموح والسريع يبحث عن إحداث مفاجأة مدوية في البطولة. لقاء يعد بالكثير من الإثارة والتكتيك.
          </p>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4 border-r-4 border-[var(--wc-red)] pr-4">
            موعد مباراة كندا ضد قطر (المجموعة الثانية - 18 يونيو)
          </h2>
          <p>
            يكتب <strong>المنتخب القطري</strong> (العنابي) فصلاً جديداً في مسيرته المونديالية عندما يواجه <strong>المنتخب الكندي</strong> 
            (أحد مستضيفي البطولة) على أرضية ملعب بي سي بليس (BC Place) في فانكوفر. يتسلح القطريون بالروح القتالية والخبرة الكبيرة 
            التي اكتسبوها في السنوات الأخيرة، سعيًا لتحقيق انتصار تاريخي يعزز حظوظهم في خطف بطاقة التأهل، رغم صعوبة المهمة أمام الجماهير الكندية الغفيرة. 
            هل ينجح العنابي في إسكات أصحاب الأرض؟
          </p>
