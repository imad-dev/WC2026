    ...
    <div className="w-full bg-[#030408] flex flex-col min-h-screen">
      ...
      <article className="max-w-4xl mx-auto px-4 py-12 text-white w-full" dir="rtl">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-[var(--wc-green)] leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
          بث مباشر وتغطية حية لمباريات 18 و 19 يونيو في كأس العالم 2026: ظهور مميز للمنتخبات العربية
        </h1>
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-lg font-sans">
          <p>
            ...
            تتجه أنظار عشاق كرة القدم حول العالم يومي 18 و 19 يونيو 2026 نحو مواجهات حاسمة ومثيرة، 
            حيث تشهد البطولة استمرار المشاركة العربية بظهور المنتخب القطري الطامح لكتابة التاريخ أمام كندا، 
            ومواجهة قوية لأسود الأطلس المنتخب المغربي أمام اسكتلندا. 
          ...
          <p>
            يكتب <strong>المنتخب القطري</strong> (العنابي) فصلاً جديداً في مسيرته المونديالية عندما يواجه المنتخب الكندي(أحد مستضيفي البطولة) على أرضية ملعب بي سي بليس (BC Place) في فانكوفر. يتسلح القطريون بالروح القتالية والخبرة الكبيرة التي اكتسبوها في السنوات الأخيرة، سعيًا لتحقيق انتصار تاريخي يعزز حظوظهم في خطف بطاقة التأهل، رغم صعوبة المهمة أمام الجماهير الكندية الغفيرة. هل ينجح العنابي في إسكات أصحاب الأرض؟
          </p>
          ...
          <p>
            ...
            يسعى المنتخب المغربي لمواصلة تقديم مستوياته الرائعة التي أبهر بها العالم، وتأكيد طموحاته الكبيرة في هذه البطولة 
