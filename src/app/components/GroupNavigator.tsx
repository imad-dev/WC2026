...
export function GroupNavigator({ activeGroup, onGroupChange }: GroupNavigatorProps) {
  ...
  // TODO: API - derive groups from standings endpoint.
  const groups = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'];
  // TODO: API - derive filters from backend capabilities.
  const filters = ['All Matches', 'Group Stage', 'Knockouts', 'Live Now'];

  // TODO: API - replace hardcoded group/team mapping with teams endpoint data.
